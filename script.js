...
function updateCropPreview() {
  ...
  document
    .querySelectorAll(".requirement-stepper-btn")
    .forEach((button) => {
...
function adjustSensorValue(inputId, direction) {
  ...
  input.value = formatSteppedValue(currentValue + direction * getInputStep(input));
  input.focus();
}
...
const FORMSPREE_ENDPOINT = "https://formspree.io/f/mvzloyra";
